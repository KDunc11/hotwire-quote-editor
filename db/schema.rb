...
ActiveRecord::Schema[7.0].define(version: 2022_10_27_161825) do
  ...
  create_table "companies", force: :cascade do |t|
    ...
    t.index ["oid"], name: "index_companies_on_oid", unique: true
  end
  ...
  create_table "tokens", force: :cascade do |t|
    ...
    t.boolean "available_for_company", default: true, null: false
    t.index ["available_for_company"], name: "index_tokens_on_available_for_company"
